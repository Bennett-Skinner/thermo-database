...
"miozzi2020_hcpfe-lowP_thermo_raw.dat"
into the database format file
"miozzi2020_hcpfe-lowP_thermo.dat"
'''
...
INPUT_FILE = os.path.join(FOLDER, "miozzi2020_hcpfe-lowP_thermo_raw.dat")
OUTPUT_FILE = os.path.join(FOLDER, "miozzi2020_hcpfe-lowP_thermo.dat")
...
if __name__ == "__main__":
    ...
    df2["rho[kg/m^3]"] = mass_cell_kg / (df["V"] * 1e-30)
    df2["drho[kg/m^3]"] = df2["rho[kg/m^3]"] * df["dV"] / df["V"]
